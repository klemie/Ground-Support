...
async function getRocketSim(id: string): Promise<IApiResponse> {
    ...
    try {
        ...
        data = {
            data: response.data.result 
                ? response.data.result as IRocketSimModel
                : response.data.results as IRocketSimModel,
            error: handleError(response)
        };
    } catch (e) {
        const err = e as AxiosError;
 ...
 */
async function createRocketSim(payload: IRocketSimModel): Promise<IApiResponse> {
    let response: AxiosResponse;
    let data: IApiResponse = {
        data: {} as IRocket,
        error: {} as IError
 ...
 * @returns The updated rocket
 */
async function updateRocketSim(id: string, payload: IRocketSimModel): Promise<IApiResponse> {
    let response: AxiosResponse;
    let data: IApiResponse = {
        data: {} as IRocketSimModel,
        error: {} as IError
